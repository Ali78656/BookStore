          ...
          <div className="navbar-end flex items-center gap-3 justify-end">
            ...
            <label className="swap swap-rotate">
              ...
              <input
                ...
                value="synthwave"
                checked={theme === "dark"} // Control checkbox state with theme
                onChange={() => setTheme(theme === "dark" ? "light" : "dark")} // Toggle theme on change
              />
            ...
            {authUser && (
              <div className="dropdown dropdown-end">
                <div
                  ...
                  className="btn btn-ghost btn-circle"
                  onClick={() =>
                    document.getElementById("my_cart_modal").showModal()
                  }
                >
                  <div className="indicator">
                    <svg
